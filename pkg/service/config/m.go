...
func (c *ConfigService) RGet(path string) any {
	return c.Raw.Get(path)
}

// Return all config as a map
func (c *ConfigService) RAll() (map[string]any, error) {
...
func (c *ConfigService) RAllJson() ([]byte, error) {
	cfg, err := c.RAll()
	if err != nil {
		return nil, err
	}
...
func (c *ConfigService) RAllJsonPretty() ([]byte, error) {
	cfg, err := c.RAll()
	if err != nil {
		return nil, err
	}
...
func (c *ConfigService) All() (model_config.Config, error) {
...
func (c *ConfigService) AllJson() ([]byte, error) {
	cfg, err := c.All()
	if err != nil {
		return nil, err
	}
...
func (c *ConfigService) AllJsonPretty() ([]byte, error) {
	cfg, err := c.All()
	if err != nil {
		return nil, err
	}
